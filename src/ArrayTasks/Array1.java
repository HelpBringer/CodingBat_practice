...
/*
   ...
   /* Given an array of ints, return the sum of the first 2 elements in the array. If the array length is less than 2, just sum up the elements that exist,
    ...
    public int sum2(int[] nums) {
        return (nums.length<1)?0 : (nums.length == 1)?nums[0] : nums[0]+nums[1];
    }
...
/*    Given an int array, return a new array with double the length where its last element is the same as the original array, and all the other elements are 0. The original array will be length 1 or more. Note: by default, a new int array contains all 0's.
   ...
   /* Given an int array length 3, if there is a 2 in the array immediately followed by a 3, set the 3 element to 0. Return the changed array.
    ...
    /*Given an array of ints of even length, return a new array length 2 containing the middle two elements from the original array. The original array will be
    length 2 or more.
...
//---------------------------------------------//
    ...
    public int[] plusTwo(int[] a, int[] b) {
        return java.util.stream.IntStream.concat(Arrays.stream(a), Arrays.stream(b)).toArray();
    }
//---------------------------------------------//
    ...
    /*We'll say that a 1 immediately followed by a 3 in an array is an "unlucky" 1. Return true if the given array contains an unlucky 1 in the first 2
